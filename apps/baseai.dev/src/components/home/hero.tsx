...
export default function Hero({ }) {
	return (
		<div className="flex align-center h-full flex-col items-center justify-center relative mt-[74px] sm:mt-0">
			<div className="xmin-h-screen h-full webgl absolute -top-[28vh] flex w-full sm:-top-16">
				<WebGLInitializer />
			</div>
			<Content />
		</div>
...
function Content() {
	return (
		<div className="z-10 grid min-h-[75vh] w-[90vw] grid-rows-[auto_1fr_auto] gap-4 px-6 sm:p-6 sm:mt-[104px] sm:min-h-[85vh] sm:w-[76vw]">
