...
export default function Hero({ }) {
	return (
		<div className="flex align-center min-h-screen flex-col items-center justify-center relative">
			<div className="xmin-h-screen h-full webgl absolute -top-[13vh] flex w-full sm:top-0">
				<WebGLInitializer />
			</div>
			<Content />
		</div>
