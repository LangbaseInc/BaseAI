...
function HighlightQuery({ text, query }: { text: string; query: string }) {
	return (
		<Highlighter
			highlightClassName="underline bg-transparent text-warning dark:text-[#fad000]"
			searchWords={[query]}
			autoEscape={true}
...
function SearchResult({
	...
	let sectionTitle = navigationData.find(section =>
	...
	return (
		...
		>
			<div
				id={`${id}-title`}
				aria-hidden="true"
				className="text-sm font-medium text-[#19182E] dark:text-white dark:group-aria-selected:text-[#fad000]"
			>
